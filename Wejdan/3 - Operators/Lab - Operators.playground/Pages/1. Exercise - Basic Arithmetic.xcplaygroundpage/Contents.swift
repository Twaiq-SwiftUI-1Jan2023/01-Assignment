...
print("result\(integerDivisionResult)")
...
let pi = 3.1415927 
let radius=5.0
let calculate=2 * radius
let calculate1=2 * pi * radius
print("result\(calculate)")
print("result\(calculate1)")
...
let even=2/2
let odd=7/2
print(" result even=\(even)result odd=\(odd)")
/*:
