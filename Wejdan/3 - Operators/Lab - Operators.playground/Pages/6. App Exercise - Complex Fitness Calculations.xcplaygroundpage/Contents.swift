 ...
 */
var separateheart1=40
var separateheart2=53
var separateheart3=30
var add=separateheart1+separateheart2+separateheart3
var average=add/3
print(average)
...
let temp=tempInFahrenheit-32
let result=temp*(5.0/9.0)
print(result)
