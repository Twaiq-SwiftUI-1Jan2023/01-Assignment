...
let HeartRate1 :Double=45.0
let HeartRate2 :Double=60.89
let HeartRate3 :Double=90.55
let addedHRD1=HeartRate1+HeartRate2+HeartRate3
let averageHRD1=addedHRD1/3
print(averageHRD1)
