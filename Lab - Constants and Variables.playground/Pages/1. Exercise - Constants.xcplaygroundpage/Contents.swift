 ...
 */
 //logic Error because we can't change the constant value
 //friends = 50
 ...
 */
print ("No is not compile is logic Error because we can't change the constant value")
