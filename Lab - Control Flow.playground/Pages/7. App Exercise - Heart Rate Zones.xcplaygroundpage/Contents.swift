...
case 141  ... 160 :
    print ("You Are in the Modarate Zone. Activity in this zone helps improve aerobic fitness.")
case 161 ... 180 :
    print ("You are in the hard zone. Activity in this zone increase maximum performane capcityfor the shorter sessions.")
case 181 ... 200 :
    print ("You are in the Maximum zone. Activity in this zone helps fit athletes develop speed.")
default :
     print ("Woaah slow down")
/*:
