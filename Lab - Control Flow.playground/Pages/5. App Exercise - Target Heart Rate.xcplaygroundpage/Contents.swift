...
let isAboveTarget = 170

if isInTarget == currentHR
{
    print ("Good jop you are acheve a target !")
}
else if isBelowTarget >= targetLowerBound
{
    print ("unfortunately you are under the target please work Hard! ")
}
else if isAboveTarget <= targetUpperBound
{
    print ("slow down !")
}
