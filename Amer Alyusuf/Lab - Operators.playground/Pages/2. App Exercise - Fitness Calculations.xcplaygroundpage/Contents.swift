...
/* A double will include decimals in the result.
 An Int will round down the result of division if it includes decimals */
...
print("Achieved \(percentOfGoal)% of the target goal steps so far.")
