...
piggyBank += 10
print("The result after your neighbor gives you 10 dollars is : \(piggyBank)")

piggyBank += 20
print("The result after you earn 20 more dollars throughout the week   is : \(piggyBank)")

piggyBank /= 2
print("You are spend half your money on dinner and a movie  , So the result is \(piggyBank)")

piggyBank *= 3
print("after tour money is triple from washing windows is : \(piggyBank)")

piggyBank -= 3
print ("after spend 3 dollars at a convenience store \(piggyBank)")
