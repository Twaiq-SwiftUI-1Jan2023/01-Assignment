 ...
 */
let heartRate1 = 90 , heartRate2 = 80 ,heartRate3 = 100
let addedHR  = heartRate1 + heartRate2 + heartRate3
let average = addedHR / 3

print ("the average heart rate over the last hour is : \(average)")
/*:
 ...
 */
let heartRate1D : Double = 90 , heartRate2D : Double = 80 , heartRate3D : Double = 100
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHR / 3

print ("the average heart rate over the last hour is : \(averageHRD)")
 ...
 */
let steps: Double = 3.467 , goal: Double = 10.000
let percentOfGoal = (goal / steps) * 100
