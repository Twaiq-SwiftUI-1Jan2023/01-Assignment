 ...
 */
let heartRate1 : Double = 70 , heartRate2 : Double = 90 , heartRate3 : Double = 100

print ("The avearge of heart rate is : \((heartRate1 + heartRate2 + heartRate3)/3)")
/*:
...
var res = (tempInFahrenheit - 32) * (5.0/9.0)
var celsius  = res

print("your body temperature in fahrenheit  is : \(tempInFahrenheit) and in celsius is : \(celsius)")
