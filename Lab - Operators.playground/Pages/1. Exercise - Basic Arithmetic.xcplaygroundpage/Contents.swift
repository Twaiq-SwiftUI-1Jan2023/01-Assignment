...
let value = width + width + height + height
print(value)
...
print(3)
let integerDicisionResult : Int = 10 / 3
print(integerDicisionResult)
...
let even = 4
let odd = 3
print("if the reminder operation = 0 then its even and if it not equal to 0 then its odd")
/*:
